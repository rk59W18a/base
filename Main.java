...
{	
	...
	public static void main(String[] args) 
	{
		...
		/**
		 * L'operazione di salvataggio prevede la costruzione di una nuova RaccoltaDati attraverso i parametri AnagraficaFruitori, AnagraficaOperatori, Archivio, ArchivioPrestiti e ArchivoStorico
		 * e l'aggiornamento del file in gestoreRisorse
		 */
